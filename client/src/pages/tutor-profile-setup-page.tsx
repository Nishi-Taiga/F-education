...
import { PencilIcon, Home, Save, X, ArrowLeft } from "lucide-react";
...
export default function TutorProfileSetupPage() {
  ...
  }, [tutorProfile, form, user?.email]);
  
  // プロフィールが完了しているユーザーはマイページにリダイレクト
  useEffect(() => {
    if (tutorProfile && tutorProfile.profileCompleted) {
      setLocation("/");
    }
  }, [tutorProfile, setLocation]);
