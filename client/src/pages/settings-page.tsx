        ...
        <Tabs value={currentTab} onValueChange={setCurrentTab}>
          ...
          <TabsContent value="students">
            ...
            <Dialog open={addDialogOpen} onOpenChange={setAddDialogOpen}>
              <DialogContent className="sm:max-w-[500px] max-h-[80vh] overflow-y-auto pt-4">
                <DialogHeader>
                ...
                <DialogFooter className="flex-col sm:flex-row gap-2 sm:gap-0 sticky bottom-0 bg-background pt-4 mt-4 border-t">
                  <Button 
                    type="button" 
                    variant="outline" 
                    className="text-xs md:text-sm px-3 md:px-4 py-1 md:py-2 h-8 md:h-9 w-full sm:w-auto"
